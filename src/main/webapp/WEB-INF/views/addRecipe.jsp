                ...
                <div class="card-body">
                    <form:form method="POST" modelAttribute="recipe" class="form-signin">
                        <spring:bind path="name">
                            <form:label path="name" cssStyle="color: white">Nazwij przepis</form:label>
                        ...
                        <div class="form-group" style="padding-top: 7.5%">
                            <input type="submit" value="Dodaj przepis" class="btn float-right register_btn">
                            <div style="margin-top: 2.5%">
                                <a href="${contextPath}/mainPage" style="color: #FFC312">Anuluj dodawanie</a>
                            </div>
                        </div>
                    </form:form>
                </div>
